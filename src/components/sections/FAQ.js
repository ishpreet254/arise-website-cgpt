...
const CLOUD_SHAPES = {
  wide: { ratio: 1672 / 941 },
  // Night art is 1536x1024 (3:2); day art is a hair narrower at 1473x1068 —
  // shared ratio uses night (the default theme) as canonical, so day
  // letterboxes by a barely-visible ~8% under background-size:contain.
  tall: { ratio: 1536 / 1024 },
  round: { ratio: 1536 / 1024 },
